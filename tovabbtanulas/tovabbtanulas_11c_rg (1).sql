...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 17. 09:34
...
CREATE TABLE `altalanos_iskola` (
  `id_altalanos_iskola` tinyint(4) NOT NULL,
...
(5, 'Napsugár Általános Iskola', 'Gyöngyvirág u.4.'),
(6, 'Tóparti Általános Iskola', 'Strand út 23.');
...
(4, 'Dobogókő Szakközépiskola', 'Sziklás u.44.'),
(6, 'Kékes Gimnázium', 'Havas út 51.'),
(7, 'Baradla Gimnázium', 'Köves tér 3.');
...
--
ALTER TABLE `altalanos_iskola`
  MODIFY `id_altalanos_iskola` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tanulo`
  MODIFY `id_tanulo` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
